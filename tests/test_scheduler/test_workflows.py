...
@pytest.mark.asyncio
async def test_run_post_workflow_returns_error_for_missing_account(monkeypatch):
    """When the account does not exist, run_post_workflow returns an error."""
    from socialmind.scheduler import workflows as wf_mod
...
@pytest.mark.asyncio
async def test_run_post_workflow_returns_error_for_inactive_account(monkeypatch):
